...
namespace Drupal\bt_crm_client\Breadcrumb;
...
class ContactsBreadcrumbBuilder implements BreadcrumbBuilderInterface{
    ...
    private $routes = array(
      'page_manager.page_view_bt_add_client_bt_add_client-panels_variant-0',
      ...
      'page_manager.page_view_bt_add_contact',
      'page_manager.page_view_bt_add_potential_client',
      ...
      'page_manager.page_view_bt_add_company',
    ...
    */
    public function build(RouteMatchInterface $route_match) {
		...
		if (preg_match("/entity.redhen_org./", $route)) {
	  	...
	  	if (preg_match("/page_manager.page_view_bt_add_(client|contact|potential_client)/", $route)) {
		  $breadcrumb->addLink(Link::createFromRoute('Persons', 'page_manager.page_view_app_persons_app_persons-panels_variant-0'));
		  $breadcrumb->addLink(Link::createFromRoute('Add Person', 'entity.redhen_contact.add_page'));
		}
