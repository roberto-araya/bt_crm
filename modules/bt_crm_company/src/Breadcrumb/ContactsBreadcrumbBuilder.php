...
namespace Drupal\bt_crm_company\Breadcrumb;
 ...
 *
 * @package Drupal\bt_crm_company\Breadcrumb
 */
class ContactsBreadcrumbBuilder implements BreadcrumbBuilderInterface {
  ...
  private $routes = array(
    'page_manager.page_view_bt_add_company_bt_add_company-panels_variant-0',
  );
